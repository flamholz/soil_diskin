...
# read lognormal cdfs generated by the Python 04b pipeline
print("Generating lognormal model predictions...")
fname = '04b_lognormal_cdfs_python.csv'
fname_05 = '04b_lognormal_cdfs_05_python.csv'
fname_95 = '04b_lognormal_cdfs_95_python.csv'
