...
fname = '04b_lognormal_cdfs_julia.csv'
fname_05 = '04b_lognormal_cdfs_05_julia.csv'
fname_95 = '04b_lognormal_cdfs_95_julia.csv'
...
result.to_csv('results/04_model_predictions/lognormal_model_predictions_julia.csv', index=False)
