...
# Load the site data
site_data = pd.read_csv('results/processed_balesdent_2018_all.csv')
turnover_14C = pd.read_csv('results/all_sites_14C_turnover.csv')

# Power-law model
# Load the power-law parameters
power_law_params = pd.read_csv(
...
np.savetxt(f'results/04_model_predictions/power_law_{current_date}_all2.csv', predictions)
...
# TODO: test against Fortran implementation
