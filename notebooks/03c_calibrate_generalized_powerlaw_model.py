...
result_df['modeled_tau'] = result_df.apply(lambda x: GeneralPowerLawDisKin(x['tau_0'], x['tau_inf']).T, axis=1)
result_df['modeled_14C'] = result_df.apply(lambda x: quad(GeneralPowerLawDisKin(x['tau_0'], x['tau_inf']).radiocarbon_age_integrand, 0, np.inf, limit=1500,epsabs=1e-3)[0], axis=1)
